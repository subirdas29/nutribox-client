...
const PendingOrdersOfCustomer = ({ myorders,meta}:{myorders:TOrderAllData[],meta:IMeta}) => {
  ...
  const pendingOrders = myorders?.filter((ongoing)=>ongoing.status==="pending")
...
export default PendingOrdersOfCustomer;
